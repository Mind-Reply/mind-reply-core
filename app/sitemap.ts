...
const routes = [
  ...
  { path: "/for-agencies", priority: 0.93, changeFrequency: "daily" as const, localized: true },
  { path: "/client-communication-automation", priority: 0.91, changeFrequency: "daily" as const, localized: true },
  { path: "/client-update-reports", priority: 0.89, changeFrequency: "daily" as const, localized: true },
